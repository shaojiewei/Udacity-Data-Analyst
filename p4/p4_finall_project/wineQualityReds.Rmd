...
ggplot(redwine_df, aes(x = fixed.acidity)) +
...
pp1 <- ggplot(redwine_df, aes(x = volatile.acidity)) +
  geom_histogram(binwidth = 0.02) +
  scale_x_continuous(breaks = seq(0, 1.6, by = 0.1))

# 绘制 volatile.acidity log10直方图
pp2 <- ggplot(redwine_df, aes(x = volatile.acidity)) +
  geom_histogram(binwidth = 0.02) +
...
```{r echo=FALSE}
# 绘制 pH 直方图
p1 <- ggplot(redwine_df, aes(x = pH)) +
  geom_histogram(binwidth = 0.02)

# 绘制 free.sulfur.dioxide 直方图
p2 <- ggplot(redwine_df, aes(x = free.sulfur.dioxide)) +
  geom_histogram(binwidth = 1)

# 绘制 total.sulfur.dioxide 直方图
p3 <- ggplot(redwine_df, aes(x = total.sulfur.dioxide)) +
  geom_histogram(binwidth = 3)

# 绘制 alcohol 直方图
p4 <- ggplot(redwine_df, aes(x = alcohol)) +
  geom_histogram(binwidth = 0.1)
...
# 绘制 citric.acid 直方图
ggplot(redwine_df, aes(x = citric.acid)) +
  geom_histogram(binwidth = 0.02)+
...
# 绘制 chlorides 直方图
ggplot(redwine_df, aes(x = chlorides)) +
...
# 绘制 density 直方图
ggplot(redwine_df, aes(x = density)) +
  geom_histogram()
...
# 绘制 sulphates 直方图
ggplot(redwine_df, aes(x = sulphates)) +
  geom_histogram(binwidth = 0.02)
